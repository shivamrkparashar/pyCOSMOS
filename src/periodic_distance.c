...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "periodic_distance",
        "sources": [
            "periodic_distance.pyx"
        ]
    },
    "module_name": "periodic_distance"
}
END: Cython Metadata */
...
#define __PYX_HAVE__periodic_distance
#define __PYX_HAVE_API__periodic_distance
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'periodic_distance' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static double __pyx_v_17periodic_distance_Lx;
static double __pyx_v_17periodic_distance_Ly;
static double __pyx_v_17periodic_distance_Lz;
static double __pyx_v_17periodic_distance_alpha;
static double __pyx_v_17periodic_distance_beta;
static double __pyx_v_17periodic_distance_gamma;
...
static double __pyx_f_17periodic_distance_distance(__Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "periodic_distance"
extern int __pyx_module_is_main_periodic_distance;
int __pyx_module_is_main_periodic_distance = 0;

/* Implementation of 'periodic_distance' */
...
static const char __pyx_k_periodic_distance[] = "periodic_distance";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_periodic_distance_pyx[] = "periodic_distance.pyx";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_distance_matrix_periodic[] = "distance_matrix_periodic";
static const char __pyx_k_periodic_distance_matrix[] = "periodic_distance_matrix";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_periodic_distance_matrix_view[] = "periodic_distance_matrix_view";
...
static PyObject *__pyx_n_s_distance_matrix_periodic;
...
static PyObject *__pyx_n_s_periodic_distance;
static PyObject *__pyx_n_s_periodic_distance_matrix;
static PyObject *__pyx_n_s_periodic_distance_matrix_view;
static PyObject *__pyx_kp_s_periodic_distance_pyx;
...
static PyObject *__pyx_pf_17periodic_distance_distance_matrix_periodic(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x_arr, __Pyx_memviewslice __pyx_v_y_arr, __Pyx_memviewslice __pyx_v_z_arr); /* proto */
...
static double __pyx_f_17periodic_distance_distance(__Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_v2) {
  double __pyx_v_dx;
  double __pyx_v_dy;
  double __pyx_v_dz;
  double __pyx_v_squared_distance;
  double __pyx_v_dist;
  double __pyx_r;
 ...
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  __pyx_v_dx = ((*((double *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_1 * __pyx_v_v1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_v2.data + __pyx_t_2 * __pyx_v_v2.strides[0]) ))));

  /* "periodic_distance.pyx":35
 * 
 *     dx = v1[0] - v2[0]
 *     dy = v1[1] - v2[1]             # <<<<<<<<<<<<<<
 *     dz = v1[2] - v2[2]
 ...
 */
  __pyx_t_2 = 1;
  __pyx_t_1 = 1;
  __pyx_v_dy = ((*((double *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_2 * __pyx_v_v1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_v2.data + __pyx_t_1 * __pyx_v_v2.strides[0]) ))));

  /* "periodic_distance.pyx":36
 *     dx = v1[0] - v2[0]
 *     dy = v1[1] - v2[1]
 *     dz = v1[2] - v2[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = 2;
  __pyx_t_2 = 2;
  __pyx_v_dz = ((*((double *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_1 * __pyx_v_v1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_v2.data + __pyx_t_2 * __pyx_v_v2.strides[0]) ))));

  /* "periodic_distance.pyx":38
 *     dz = v1[2] - v2[2]
 * 
 *     if fabs(dx) > Lx/2:             # <<<<<<<<<<<<<<
 *         dx = Lx - fabs(dx)
 * 
 */
  __pyx_t_3 = ((fabs(__pyx_v_dx) > (__pyx_v_17periodic_distance_Lx / 2.0)) != 0);
  if (__pyx_t_3) {

    /* "periodic_distance.pyx":39
 * 
 *     if fabs(dx) > Lx/2:
 *         dx = Lx - fabs(dx)             # <<<<<<<<<<<<<<
 * 
 *     if fabs(dy) > Ly/2:
 */
    __pyx_v_dx = (__pyx_v_17periodic_distance_Lx - fabs(__pyx_v_dx));
 ...
 * 
 */
  __pyx_t_3 = ((fabs(__pyx_v_dy) > (__pyx_v_17periodic_distance_Ly / 2.0)) != 0);
  if (__pyx_t_3) {

    /* "periodic_distance.pyx":42
 * 
 *     if fabs(dy) > Ly/2:
 *         dy = Ly - fabs(dy)             # <<<<<<<<<<<<<<
 * 
 *     if fabs(dz) > Lz/2:
 */
    __pyx_v_dy = (__pyx_v_17periodic_distance_Ly - fabs(__pyx_v_dy));
 ...
 * 
 */
  __pyx_t_3 = ((fabs(__pyx_v_dz) > (__pyx_v_17periodic_distance_Lz / 2.0)) != 0);
  if (__pyx_t_3) {

    /* "periodic_distance.pyx":45
 * 
 *     if fabs(dz) > Lz/2:
 *         dz = Lz - fabs(dz)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_dz = (__pyx_v_17periodic_distance_Lz - fabs(__pyx_v_dz));
 ...
 */
  __pyx_v_squared_distance = ((((((__pyx_v_dx * __pyx_v_dx) + (__pyx_v_dy * __pyx_v_dy)) + (__pyx_v_dz * __pyx_v_dz)) + (((2.0 * __pyx_v_dx) * __pyx_v_dy) * cos(__pyx_v_17periodic_distance_gamma))) + (((2.0 * __pyx_v_dy) * __pyx_v_dz) * cos(__pyx_v_17periodic_distance_alpha))) + (((2.0 * __pyx_v_dz) * __pyx_v_dx) * cos(__pyx_v_17periodic_distance_beta)));

  /* "periodic_distance.pyx":52
 *                        + 2*dy*dz*cos(alpha) + 2*dz*dx*cos(beta)
 * 
 *     dist = sqrt(squared_distance)             # <<<<<<<<<<<<<<
 * 
 *     return dist
 */
  __pyx_v_dist = sqrt(__pyx_v_squared_distance);

  /* "periodic_distance.pyx":54
 *     dist = sqrt(squared_distance)
 * 
 *     return dist             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_17periodic_distance_1distance_matrix_periodic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_17periodic_distance_1distance_matrix_periodic = {"distance_matrix_periodic", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17periodic_distance_1distance_matrix_periodic, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_17periodic_distance_1distance_matrix_periodic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_y_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_z_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("distance_matrix_periodic (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x_arr,&__pyx_n_s_y_arr,&__pyx_n_s_z_arr,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_arr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("distance_matrix_periodic", 1, 3, 3, 1); __PYX_ERR(0, 58, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_arr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("distance_matrix_periodic", 1, 3, 3, 2); __PYX_ERR(0, 58, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "distance_matrix_periodic") < 0)) __PYX_ERR(0, 58, __pyx_L3_error)
      }
    ...
    __pyx_v_x_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x_arr.memview)) __PYX_ERR(0, 58, __pyx_L3_error)
    __pyx_v_y_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y_arr.memview)) __PYX_ERR(0, 58, __pyx_L3_error)
    __pyx_v_z_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z_arr.memview)) __PYX_ERR(0, 58, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("distance_matrix_periodic", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 58, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("periodic_distance.distance_matrix_periodic", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_17periodic_distance_distance_matrix_periodic(__pyx_self, __pyx_v_x_arr, __pyx_v_y_arr, __pyx_v_z_arr);
...
static PyObject *__pyx_pf_17periodic_distance_distance_matrix_periodic(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x_arr, __Pyx_memviewslice __pyx_v_y_arr, __Pyx_memviewslice __pyx_v_z_arr) {
  int __pyx_v_Npoints;
  PyObject *__pyx_v_periodic_distance_matrix = NULL;
  __Pyx_memviewslice __pyx_v_periodic_distance_matrix_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  __Pyx_memviewslice __pyx_v_vi = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_vj = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("distance_matrix_periodic", 0);

  /* "periodic_distance.pyx":60
 * def distance_matrix_periodic(double [:]x_arr, double [:] y_arr, double [:] z_arr):
 * 
 *     cdef int Npoints = len(x_arr)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_Npoints); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_Npoints); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 62, __pyx_L1_error)
  ...
  __pyx_v_periodic_distance_matrix = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "periodic_distance.pyx":63
 * 
 *     periodic_distance_matrix = np.zeros((Npoints, Npoints))
 *     cdef double [:, :] periodic_distance_matrix_view = periodic_distance_matrix             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_periodic_distance_matrix, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 63, __pyx_L1_error)
  __pyx_v_periodic_distance_matrix_view = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "periodic_distance.pyx":68
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_vi = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "periodic_distance.pyx":69
 *     cdef Py_ssize_t i, j
 *     cdef double [:] vi = np.zeros(3)
 *     cdef double [:] vj = np.zeros(3)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
  ...
  __pyx_t_2 = (__pyx_t_6) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_6, __pyx_int_3) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_int_3);
  __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_vj = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "periodic_distance.pyx":73
 * 
 ...
 */
                            ...
                            __pyx_t_13 = 0;
                            *((double *) ( /* dim=0 */ (__pyx_v_vi.data + __pyx_t_13 * __pyx_v_vi.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_x_arr.data + __pyx_t_12 * __pyx_v_x_arr.strides[0]) )));

                            /* "periodic_distance.pyx":75
 *     for i in prange(Npoints, nogil =True):
 *         vi[0] = x_arr[i]
 *         vi[1] = y_arr[i]             # <<<<<<<<<<<<<<
 *         vi[2] = z_arr[i]
 ...
 */
                            __pyx_t_12 = __pyx_v_i;
                            __pyx_t_13 = 1;
                            *((double *) ( /* dim=0 */ (__pyx_v_vi.data + __pyx_t_13 * __pyx_v_vi.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_y_arr.data + __pyx_t_12 * __pyx_v_y_arr.strides[0]) )));

                            /* "periodic_distance.pyx":76
 *         vi[0] = x_arr[i]
 *         vi[1] = y_arr[i]
 *         vi[2] = z_arr[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            __pyx_t_12 = __pyx_v_i;
                            __pyx_t_13 = 2;
                            *((double *) ( /* dim=0 */ (__pyx_v_vi.data + __pyx_t_13 * __pyx_v_vi.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_z_arr.data + __pyx_t_12 * __pyx_v_z_arr.strides[0]) )));

                            /* "periodic_distance.pyx":79
 * 
 * 
 ...
 */
                                ...
                                __pyx_t_13 = 0;
                                *((double *) ( /* dim=0 */ (__pyx_v_vj.data + __pyx_t_13 * __pyx_v_vj.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_x_arr.data + __pyx_t_12 * __pyx_v_x_arr.strides[0]) )));

                                /* "periodic_distance.pyx":82
 *             if (i >= j):
 *                 vj[0] = x_arr[j]
 *                 vj[1] = y_arr[j]             # <<<<<<<<<<<<<<
 *                 vj[2] = z_arr[j]
 ...
 */
                                __pyx_t_12 = __pyx_v_j;
                                __pyx_t_13 = 1;
                                *((double *) ( /* dim=0 */ (__pyx_v_vj.data + __pyx_t_13 * __pyx_v_vj.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_y_arr.data + __pyx_t_12 * __pyx_v_y_arr.strides[0]) )));

                                /* "periodic_distance.pyx":83
 *                 vj[0] = x_arr[j]
 *                 vj[1] = y_arr[j]
 *                 vj[2] = z_arr[j]             # <<<<<<<<<<<<<<
 *                 periodic_distance_matrix_view[i, j] = distance(vi, vj)
 ...
 */
                                __pyx_t_12 = __pyx_v_j;
                                __pyx_t_13 = 2;
                                *((double *) ( /* dim=0 */ (__pyx_v_vj.data + __pyx_t_13 * __pyx_v_vj.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_z_arr.data + __pyx_t_12 * __pyx_v_z_arr.strides[0]) )));

                                /* "periodic_distance.pyx":84
 *                 vj[1] = y_arr[j]
 *                 vj[2] = z_arr[j]
 *                 periodic_distance_matrix_view[i, j] = distance(vi, vj)             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                ...
                                *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_periodic_distance_matrix_view.data + __pyx_t_12 * __pyx_v_periodic_distance_matrix_view.strides[0]) ) + __pyx_t_13 * __pyx_v_periodic_distance_matrix_view.strides[1]) )) = __pyx_f_17periodic_distance_distance(__pyx_v_vi, __pyx_v_vj);
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j)
 ...
 */
                                ...
                                *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_periodic_distance_matrix_view.data + __pyx_t_18 * __pyx_v_periodic_distance_matrix_view.strides[0]) ) + __pyx_t_19 * __pyx_v_periodic_distance_matrix_view.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_periodic_distance_matrix_view.data + __pyx_t_13 * __pyx_v_periodic_distance_matrix_view.strides[0]) ) + __pyx_t_12 * __pyx_v_periodic_distance_matrix_view.strides[1]) )));
 ...
 */
  ...
  /* "periodic_distance.pyx":91
 *                 periodic_distance_matrix_view[i, j] = periodic_distance_matrix_view[j, i]
 * 
 *     return periodic_distance_matrix             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(__pyx_v_periodic_distance_matrix);
  __pyx_r = __pyx_v_periodic_distance_matrix;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_periodic_distance_matrix);
  __PYX_XDEC_MEMVIEW(&__pyx_v_periodic_distance_matrix_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_vi, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_vj, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_x_arr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_y_arr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_z_arr, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "periodic_distance.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "periodic_distance.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "periodic_distance.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "periodic_distance._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_periodic_distance(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_periodic_distance},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_distance_matrix_periodic, __pyx_k_distance_matrix_periodic, sizeof(__pyx_k_distance_matrix_periodic), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_periodic_distance, __pyx_k_periodic_distance, sizeof(__pyx_k_periodic_distance), 0, 0, 1, 1},
  {&__pyx_n_s_periodic_distance_matrix, __pyx_k_periodic_distance_matrix, sizeof(__pyx_k_periodic_distance_matrix), 0, 0, 1, 1},
  {&__pyx_n_s_periodic_distance_matrix_view, __pyx_k_periodic_distance_matrix_view, sizeof(__pyx_k_periodic_distance_matrix_view), 0, 0, 1, 1},
  {&__pyx_kp_s_periodic_distance_pyx, __pyx_k_periodic_distance_pyx, sizeof(__pyx_k_periodic_distance_pyx), 0, 0, 1, 0},
 ...
 *     cdef int Npoints = len(x_arr)
 */
  __pyx_tuple__20 = PyTuple_Pack(10, __pyx_n_s_x_arr, __pyx_n_s_y_arr, __pyx_n_s_z_arr, __pyx_n_s_Npoints, __pyx_n_s_periodic_distance_matrix, __pyx_n_s_periodic_distance_matrix_view, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_vi, __pyx_n_s_vj); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(3, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_periodic_distance_pyx, __pyx_n_s_distance_matrix_periodic, 58, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 58, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initperiodic_distance(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initperiodic_distance(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_periodic_distance(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_periodic_distance(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_periodic_distance(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'periodic_distance' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_periodic_distance(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("periodic_distance", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_periodic_distance) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "periodic_distance")) {
      if (unlikely(PyDict_SetItemString(modules, "periodic_distance", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_config, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_config, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "periodic_distance.pyx":7
 * import config
 * 
 * cdef double Lx = config.Lx             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_Lx); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_17periodic_distance_Lx = __pyx_t_3;

  /* "periodic_distance.pyx":8
 * 
 * cdef double Lx = config.Lx
 * cdef double Ly = config.Ly             # <<<<<<<<<<<<<<
 * cdef double Lz = config.Lz
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_config); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_Ly); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_17periodic_distance_Ly = __pyx_t_3;

  /* "periodic_distance.pyx":9
 * cdef double Lx = config.Lx
 * cdef double Ly = config.Ly
 * cdef double Lz = config.Lz             # <<<<<<<<<<<<<<
 * cdef double alpha = config.alpha
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_config); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_Lz); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_17periodic_distance_Lz = __pyx_t_3;

  /* "periodic_distance.pyx":10
 * cdef double Ly = config.Ly
 * cdef double Lz = config.Lz
 * cdef double alpha = config.alpha             # <<<<<<<<<<<<<<
 * cdef double beta = config.beta
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_config); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_alpha); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_17periodic_distance_alpha = __pyx_t_3;

  /* "periodic_distance.pyx":11
 * cdef double Lz = config.Lz
 * cdef double alpha = config.alpha
 * cdef double beta = config.beta             # <<<<<<<<<<<<<<
 * cdef double gamma = config.gamma
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_config); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_beta); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_17periodic_distance_beta = __pyx_t_3;

  /* "periodic_distance.pyx":12
 * cdef double alpha = config.alpha
 * cdef double beta = config.beta
 * cdef double gamma = config.gamma             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_gamma); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_17periodic_distance_gamma = __pyx_t_3;
 ...
 *     cdef int Npoints = len(x_arr)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_17periodic_distance_1distance_matrix_periodic, NULL, __pyx_n_s_periodic_distance); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_distance_matrix_periodic, __pyx_t_1) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "periodic_distance.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * import numpy as np
 * from cython.parallel import prange
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init periodic_distance", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init periodic_distance");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
