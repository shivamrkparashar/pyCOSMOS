 ...
 */
  __pyx_t_3 = 1;
  __pyx_t_4 = 1;
  __pyx_v_dy = ((*((double *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_3 * __pyx_v_v1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_v2.data + __pyx_t_4 * __pyx_v_v2.strides[0]) ))));
 ...
 */
  __pyx_t_5 = 2;
  __pyx_t_6 = 2;
  __pyx_v_dz = ((*((double *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_5 * __pyx_v_v1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_v2.data + __pyx_t_6 * __pyx_v_v2.strides[0]) ))));

  /* "periodic_distance.pyx":47
 *     dz = v1[2] - v2[2]
 * 
 *     if fabs(dx) > Lx/2:             # <<<<<<<<<<<<<<
 *         dx = Lx - fabs(dx)
 * 
 */
  __pyx_t_7 = ((fabs(__pyx_v_dx) > (__pyx_v_17periodic_distance_Lx / 2.0)) != 0);
  if (__pyx_t_7) {

    /* "periodic_distance.pyx":48
 * 
 *     if fabs(dx) > Lx/2:
 *         dx = Lx - fabs(dx)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_7 = ((fabs(__pyx_v_dy) > (__pyx_v_17periodic_distance_Ly / 2.0)) != 0);
  if (__pyx_t_7) {

    /* "periodic_distance.pyx":51
 * 
 *     if fabs(dy) > Ly/2:
 *         dy = Ly - fabs(dy)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_7 = ((fabs(__pyx_v_dz) > (__pyx_v_17periodic_distance_Lz / 2.0)) != 0);
  if (__pyx_t_7) {
 ...
 * 
 */
  __pyx_v_squared_distance = (((__pyx_v_dx * __pyx_v_dx) + (__pyx_v_dy * __pyx_v_dy)) + (__pyx_v_dz * __pyx_v_dz));

  /* "periodic_distance.pyx":57
 * 
 *     squared_distance = dx*dx + dy*dy + dz*dz
 *     dist = sqrt(squared_distance)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_17periodic_distance_1distance_matrix_periodic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("distance_matrix_periodic (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_arr)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("distance_matrix_periodic", 1, 3, 3, 1); __PYX_ERR(0, 64, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_arr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("distance_matrix_periodic", 1, 3, 3, 2); __PYX_ERR(0, 64, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "distance_matrix_periodic") < 0)) __PYX_ERR(0, 64, __pyx_L3_error)
      }
    ...
    __pyx_v_x_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x_arr.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_y_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y_arr.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_z_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z_arr.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("distance_matrix_periodic", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 64, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_Npoints); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_Npoints); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_periodic_distance_matrix, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 72, __pyx_L1_error)
  __pyx_v_periodic_distance_matrix_view = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "periodic_distance.pyx":97
 *     """
 *     cdef Py_ssize_t i, j
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_vi = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "periodic_distance.pyx":98
 *     cdef Py_ssize_t i, j
 *     cdef double [:] vi = np.zeros(3)
 *     cdef double [:] vj = np.zeros(3)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_vj = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "periodic_distance.pyx":102
 * 
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_22, __pyx_t_23, __pyx_t_24, __pyx_t_25, __pyx_t_26, __pyx_t_27, __pyx_t_28, __pyx_t_29)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
 ...
 */
                            ...
                            __pyx_t_15 = 1;
                            *((double *) ( /* dim=0 */ (__pyx_v_vi.data + __pyx_t_15 * __pyx_v_vi.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_y_arr.data + __pyx_t_14 * __pyx_v_y_arr.strides[0]) )));

                            /* "periodic_distance.pyx":105
 *         vi[0] = x_arr[i]
 *         vi[1] = y_arr[i]
 *         vi[2] = z_arr[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            ...
                            __pyx_t_17 = 2;
                            *((double *) ( /* dim=0 */ (__pyx_v_vi.data + __pyx_t_17 * __pyx_v_vi.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_z_arr.data + __pyx_t_16 * __pyx_v_z_arr.strides[0]) )));

                            /* "periodic_distance.pyx":108
 * 
 * 
 ...
 *                 vj[0] = x_arr[j]
 */
                            __pyx_t_18 = __pyx_v_Npoints;
                            __pyx_t_19 = __pyx_t_18;
                            for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
                              __pyx_v_j = __pyx_t_20;

                              /* "periodic_distance.pyx":109
 * 
 *         for j in range(Npoints):
 *             if (i >= j):             # <<<<<<<<<<<<<<
 *                 vj[0] = x_arr[j]
 ...
 */
                                ...
                                __pyx_t_23 = 0;
                                *((double *) ( /* dim=0 */ (__pyx_v_vj.data + __pyx_t_23 * __pyx_v_vj.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_x_arr.data + __pyx_t_22 * __pyx_v_x_arr.strides[0]) )));

                                /* "periodic_distance.pyx":111
 *             if (i >= j):
 *                 vj[0] = x_arr[j]
 *                 vj[1] = y_arr[j]             # <<<<<<<<<<<<<<
 *                 vj[2] = z_arr[j]
 ...
 */
                                ...
                                __pyx_t_25 = 1;
                                *((double *) ( /* dim=0 */ (__pyx_v_vj.data + __pyx_t_25 * __pyx_v_vj.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_y_arr.data + __pyx_t_24 * __pyx_v_y_arr.strides[0]) )));

                                /* "periodic_distance.pyx":112
 *                 vj[0] = x_arr[j]
 *                 vj[1] = y_arr[j]
 *                 vj[2] = z_arr[j]             # <<<<<<<<<<<<<<
 *                 periodic_distance_matrix_view[i, j] = distance(vi, vj)
 ...
 */
                                ...
                                __pyx_t_27 = 2;
                                *((double *) ( /* dim=0 */ (__pyx_v_vj.data + __pyx_t_27 * __pyx_v_vj.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_z_arr.data + __pyx_t_26 * __pyx_v_z_arr.strides[0]) )));

                                /* "periodic_distance.pyx":113
 *                 vj[1] = y_arr[j]
 *                 vj[2] = z_arr[j]
 *                 periodic_distance_matrix_view[i, j] = distance(vi, vj)             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                ...
                                *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_periodic_distance_matrix_view.data + __pyx_t_28 * __pyx_v_periodic_distance_matrix_view.strides[0]) ) + __pyx_t_29 * __pyx_v_periodic_distance_matrix_view.strides[1]) )) = __pyx_f_17periodic_distance_distance(__pyx_v_vi, __pyx_v_vj);
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_30, __pyx_t_31, __pyx_t_32, __pyx_t_33)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j)
 ...
 */
                                ...
                                *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_periodic_distance_matrix_view.data + __pyx_t_32 * __pyx_v_periodic_distance_matrix_view.strides[0]) ) + __pyx_t_33 * __pyx_v_periodic_distance_matrix_view.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_periodic_distance_matrix_view.data + __pyx_t_30 * __pyx_v_periodic_distance_matrix_view.strides[0]) ) + __pyx_t_31 * __pyx_v_periodic_distance_matrix_view.strides[1]) )));
 ...
 *     #print(len(x_arr))
 */
  __pyx_tuple__19 = PyTuple_Pack(10, __pyx_n_s_x_arr, __pyx_n_s_y_arr, __pyx_n_s_z_arr, __pyx_n_s_Npoints, __pyx_n_s_periodic_distance_matrix, __pyx_n_s_periodic_distance_matrix_view, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_vi, __pyx_n_s_vj); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(3, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_periodic_distance_pyx, __pyx_n_s_distance_matrix_periodic, 64, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 64, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_config, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_Box); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Box, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "periodic_distance.pyx":14
 * 
 ...
 * cdef double Lz = Box
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_Box); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_Box); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_Box); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     #print(len(x_arr))
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_17periodic_distance_1distance_matrix_periodic, NULL, __pyx_n_s_periodic_distance); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_distance_matrix_periodic, __pyx_t_2) < 0) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
